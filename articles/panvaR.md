...
#> [1] "/tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpPYDOso/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Wed Mar  4 15:53:07 2026
#> 15994 MiB RAM detected, ~14259 available; reserving 7997 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Wed Mar  4 15:53:07 2026
#> QC was successful, output stored at /tmp/RtmpPYDOso/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpPYDOso
...
#> Results are stored at Working Directory: /tmp/RtmpPYDOso 
#> End: 2026-03-04 15:53:10 UTC 
