...
#> [1] "/tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmpab0VLb/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Jul 21 19:48:01 2026
#> 15988 MiB RAM detected, ~14203 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Jul 21 19:48:01 2026
#> QC was successful, output stored at /tmp/Rtmpab0VLb/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/Rtmpab0VLb
...
#> Results are stored at Working Directory: /tmp/Rtmpab0VLb 
#> End: 2026-07-21 19:48:03 UTC 
