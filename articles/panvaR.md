...
#> [1] "/tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1"
#> PLINK v2.0.0-a.7LM AVX2 Intel (10 Mar 2026)         cog-genomics.org/plink/2.0/
#> (C) 2005-2026 Shaun Purcell, Christopher Chang    GNU General Public License v3
#> Logging to /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmplysvY6/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Wed Mar 11 21:06:01 2026
#> 15994 MiB RAM detected, ~14409 available; reserving 7997 MiB for main
#> workspace.
...
#> Writing /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Wed Mar 11 21:06:01 2026
#> QC was successful, output stored at /tmp/RtmplysvY6/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmplysvY6
...
#> Results are stored at Working Directory: /tmp/RtmplysvY6 
#> End: 2026-03-11 21:06:04 UTC 
