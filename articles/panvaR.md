...
#> [1] "/tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpMaVEnZ/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Aug 24 15:26:03 2026
#> 15989 MiB RAM detected, ~14327 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Mon Aug 24 15:26:03 2026
#> QC was successful, output stored at /tmp/RtmpMaVEnZ/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpMaVEnZ
...
#> Results are stored at Working Directory: /tmp/RtmpMaVEnZ 
#> End: 2026-08-24 15:26:05 UTC 
