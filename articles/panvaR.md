...
#> [1] "/tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpAS3x03/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Thu Mar  5 20:49:18 2026
#> 15990 MiB RAM detected, ~14381 available; reserving 7995 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Thu Mar  5 20:49:18 2026
#> QC was successful, output stored at /tmp/RtmpAS3x03/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpAS3x03
...
#> Results are stored at Working Directory: /tmp/RtmpAS3x03 
#> End: 2026-03-05 20:49:21 UTC 
