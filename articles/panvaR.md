...
#> [1] "/tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmpyp1o2W/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Mar 17 21:22:14 2026
#> 15990 MiB RAM detected, ~14272 available; reserving 7995 MiB for main
#> workspace.
...
#> Writing /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Mar 17 21:22:14 2026
#> QC was successful, output stored at /tmp/Rtmpyp1o2W/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/Rtmpyp1o2W
...
#> Results are stored at Working Directory: /tmp/Rtmpyp1o2W 
#> End: 2026-03-17 21:22:16 UTC 
