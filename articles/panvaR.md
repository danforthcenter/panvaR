...
#> [1] "/tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpTdIsIs/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Feb 24 22:10:51 2026
#> 15990 MiB RAM detected, ~14476 available; reserving 7995 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Feb 24 22:10:51 2026
#> QC was successful, output stored at /tmp/RtmpTdIsIs/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpTdIsIs
...
#> Results are stored at Working Directory: /tmp/RtmpTdIsIs 
#> End: 2026-02-24 22:10:54 UTC 
