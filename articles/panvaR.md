...
#> [1] "/tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmpz7annd/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Aug 25 21:50:59 2026
#> 15989 MiB RAM detected, ~14356 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Aug 25 21:50:59 2026
#> QC was successful, output stored at /tmp/Rtmpz7annd/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/Rtmpz7annd
...
#> Results are stored at Working Directory: /tmp/Rtmpz7annd 
#> End: 2026-08-25 21:51:01 UTC 
