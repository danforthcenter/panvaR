...
#> [1] "/tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmp60TOtr/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Fri Sep  4 15:09:04 2026
...
#> Writing /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Fri Sep  4 15:09:04 2026
#> QC was successful, output stored at /tmp/Rtmp60TOtr/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/Rtmp60TOtr
...
#> Results are stored at Working Directory: /tmp/Rtmp60TOtr 
#> End: 2026-09-04 15:09:06 UTC 
