...
#> [1] "/tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpIBJtMO/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Mar 16 22:31:51 2026
#> 15990 MiB RAM detected, ~14328 available; reserving 7995 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Mon Mar 16 22:31:51 2026
#> QC was successful, output stored at /tmp/RtmpIBJtMO/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpIBJtMO
...
#> Results are stored at Working Directory: /tmp/RtmpIBJtMO 
#> End: 2026-03-16 22:31:54 UTC 
