...
#> [1] "/tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpFogHJc/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Thu Sep  3 22:00:05 2026
#> 15989 MiB RAM detected, ~14241 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Thu Sep  3 22:00:05 2026
#> QC was successful, output stored at /tmp/RtmpFogHJc/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpFogHJc
...
#> Results are stored at Working Directory: /tmp/RtmpFogHJc 
#> End: 2026-09-03 22:00:08 UTC 
