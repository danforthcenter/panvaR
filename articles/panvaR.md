...
#> [1] "/tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpV30vAS/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Aug 24 21:48:15 2026
#> 15989 MiB RAM detected, ~14305 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Mon Aug 24 21:48:15 2026
#> QC was successful, output stored at /tmp/RtmpV30vAS/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpV30vAS
...
#> Results are stored at Working Directory: /tmp/RtmpV30vAS 
#> End: 2026-08-24 21:48:17 UTC 
