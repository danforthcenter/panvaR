...
#> [1] "/tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmp9ab3Cj/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Aug 24 16:14:32 2026
#> 15988 MiB RAM detected, ~14493 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1.fam ...
#> done.
#> Writing /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bim ...
#> done.
#> Writing /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bed ...
#> 0%done.
#> End time: Mon Aug 24 16:14:32 2026
#> QC was successful, output stored at /tmp/Rtmp9ab3Cj/panvar_ex/example_PlinkQC_maf0.05_missing0.1
...
#> Searching for prefix: GWAS.Example in directory: /tmp/Rtmp9ab3Cj/panvar_ex
