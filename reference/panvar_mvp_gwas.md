...
#> [1] "/tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpPbvXSO/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Aug 24 20:05:32 2026
#> 15989 MiB RAM detected, ~14560 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1.fam ...
#> done.
#> Writing /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bim ...
#> done.
#> Writing /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bed ...
#> 0%done.
#> End time: Mon Aug 24 20:05:32 2026
#> QC was successful, output stored at /tmp/RtmpPbvXSO/panvar_ex/example_PlinkQC_maf0.05_missing0.1
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmpPbvXSO/panvar_ex
