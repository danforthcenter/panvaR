...
#> [1] "/tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpFFoTLb/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Thu Jul 23 14:55:25 2026
#> 15989 MiB RAM detected, ~14531 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1.fam ...
#> done.
#> Writing /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bim ...
#> done.
#> Writing /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bed ...
#> 0%done.
#> End time: Thu Jul 23 14:55:25 2026
#> QC was successful, output stored at /tmp/RtmpFFoTLb/panvar_ex/example_PlinkQC_maf0.05_missing0.1
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmpFFoTLb/panvar_ex
