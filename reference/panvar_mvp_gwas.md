...
#>   --geno 0.1
#>   --keep /tmp/RtmpQWEZfS/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpQWEZfS/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Wed Mar 25 16:33:26 2026
#> 15989 MiB RAM detected, ~14513 available; reserving 7994 MiB for main
#> workspace.
...
#> 0%done.
#> End time: Wed Mar 25 16:33:26 2026
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmpQWEZfS/panvar_ex
