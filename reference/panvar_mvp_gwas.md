...
#>   --geno 0.1
#>   --keep /tmp/RtmpyxWe1J/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpyxWe1J/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Fri Sep  4 19:09:53 2026
#> 15989 MiB RAM detected, ~14579 available; reserving 7994 MiB for main
#> workspace.
...
#> 0%done.
#> End time: Fri Sep  4 19:09:53 2026
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmpyxWe1J/panvar_ex
