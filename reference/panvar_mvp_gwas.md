...
#> [1] "/tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmplV8C0N/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Mon Mar 16 21:52:44 2026
#> 15994 MiB RAM detected, ~14569 available; reserving 7997 MiB for main
#> workspace.
...
#> Writing /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1.fam ...
#> done.
#> Writing /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bim ...
#> done.
#> Writing /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1.bed ...
#> 0%done.
#> End time: Mon Mar 16 21:52:44 2026
#> QC was successful, output stored at /tmp/RtmplV8C0N/panvar_ex/example_PlinkQC_maf0.05_missing0.1
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmplV8C0N/panvar_ex
