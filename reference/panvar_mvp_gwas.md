...
#>   --geno 0.1
#>   --keep /tmp/RtmpbT85ri/panvar_ex/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpbT85ri/panvar_ex/example_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Mar 31 19:50:47 2026
#> 15988 MiB RAM detected, ~14466 available; reserving 7994 MiB for main
#> workspace.
...
#> 0%done.
#> End time: Tue Mar 31 19:50:47 2026
...
#> Searching for prefix: GWAS.Example in directory: /tmp/RtmpbT85ri/panvar_ex
