#' Apply dictionary
#'
#' @param dictionary he dictionary table has two fields - 1. plink2, the chromosomes in plink2 - 2. vcf, the chromosomes in vcf
#' @param table should have column named CHROM
#'
#' @returns
#' a table with chromosomes based on the plink files
...
#' @param super_name not sure
#' @param include_dir also return directory
#'
#' @returns
...
# I accidentally modified this one here so uncommented the one in the unsorted file.
# moved altered one to the "in_use" file. 
