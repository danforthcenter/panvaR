...
#' @examples
#' # Work in progress
plotly_panvar_manhattan <- function(panvar.table.list = NULL,
                                  gwas.res = NULL,
                                  ld.list = NULL,
                                  pvals.in.log = TRUE,
                                  plot.r2.thresh = .2,
  ...
  man <- man + guides(fill="none")
  
  # set up plotly stuff
  man.ly <- ggplotly(man, tooltip = c("POS", "PVAL", qualitative.annotation, quantitative.annotation,"plot.quant.var", "plot.R2"))
