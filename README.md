...
To get started, check out the tutorial vignette [here](https://danforthcenter.github.io/panvaR/articles/panvaR.html).
...
Please let us know if there are problems with the package via the github issues page. We are always open to improving the ease of use and functionality so also please inform us of any potential additions or features. Thanks for using our tool!
